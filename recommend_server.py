...
def sort_recall_list_by_model(r, userId, recalls, model):
    ...
    for movieId in recalls:
        ...
        # 批式：5维
        features[0], features[1] = user_features['batch2feature_userId_rating1'], user_features[
            'batch2feature_userId_rating0']
        features[2], features[3] = movie_features['batch2feature_movieId_rating1'], movie_features[
            'batch2feature_movieId_rating0']
        features[4] = user_movie_features[f'batch2feature_userId_to_movieId']
        # 实时：5维
        features[5], features[6] = user_features['streaming2feature_userId_rating1'], user_features[
            'streaming2feature_userId_rating1']
        features[7], features[8] = movie_features['streaming2feature_movieId_rating1'], movie_features[
            'streaming2feature_movieId_rating0']
...
if __name__ == "__main__":
    ...
    startup_nodes = [
        ...
        {"host": "192.168.0.208", "port": 6380},
        {"host": "192.168.0.208", "port": 6379},
        {"host": "192.168.0.114", "port": 6379},
        {"host": "192.168.0.128", "port": 6380},
        {"host": "192.168.0.128", "port": 6379}
    ]
